class Employee:
    ...
    def respond(self, job_offer: str):
        """
        Ovde vraboteniot ja odbiva ili prifakja ponudata od Company
        """
        print(job_offer)
...
class Company:
    ...
    Company_Employees = [Employee("Ime1", "Prezime1", "vraboten1@email.com", "developer", "semos_mk", 200000),
                         Employee("Ime2", "Prezime2", "Vraboten2@email.com",
                                  "developer", "semos_mk", 20000),
                         Employee("Ime3", "Prezime3", "Vraboten3@email.com",
                                  "senior developer", 300000),
                         Employee("Ime4", "Prezime4", "Vraboten4@email.com",
    ...
    def hire(self, employee: Employee, position: str, salary: int):
        """
        Tuka so funkcija Company prakja ponuda do vraboteniot
        """
    ...
    def final_response(self, employee1_response: bool, employee: Employee):
        """
        Printame poraka dali vraboteniot prifakja ili odbiva
        """
    ...
    def employee_quits(self, decision: bool, employee: Employee):
        """
        Ako vraboteniot si odi od firmata
        go briseme od listata
        """
        if (decision == True):
...
employee1 = Employee("Bob", "Bobski", "bobbobski@email.com",
                     "developer", "semos_mk")
